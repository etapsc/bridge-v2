...
Plan and execute the next slice using the bridge-slice-plan skill. Delegate to @bridge-architect (if design needed), @bridge-coder (implementation), @bridge-debugger (if tests fail).
