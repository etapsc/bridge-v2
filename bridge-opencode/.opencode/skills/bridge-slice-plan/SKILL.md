...
1. Delegate to @bridge-architect (if slice needs design) → only relevant JSON + file paths
2. Delegate to @bridge-coder → implement with tests satisfying ATxx
3. Delegate to @bridge-debugger → run tests, fix failures
