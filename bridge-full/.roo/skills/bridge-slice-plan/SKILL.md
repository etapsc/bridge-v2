...
1. Delegate to architect (if slice needs design) → only relevant JSON + file paths
2. Delegate to code → implement with tests satisfying ATxx
3. Delegate to debug → run tests, fix failures
