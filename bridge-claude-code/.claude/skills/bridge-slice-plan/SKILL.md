...
1. Delegate to bridge-architect subagent (if slice needs design) → only relevant JSON + file paths
2. Delegate to bridge-coder subagent → implement with tests satisfying ATxx
3. Delegate to bridge-debugger subagent → run tests, fix failures
